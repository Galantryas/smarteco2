...
<div id="home">
    ...
    <div id="da-slider" class="da-slider">
        ...
        <div class="container">
            <!-- Start first slide -->
            <div class="da-slide">
                <h2 class="fittext2">Pertanian</h2>
                <h4>Mengejar Jagung dengan Padi Hibrida</h4>
                <p>Dalam perkembangannya, rerata produktivitas jagung melampaui padi. Dari mulai tahun 2009 hingga 2015, kenaikan produktivitas jagung (ton per hektare) 3,62 persen. Sementara padi sawah irigasi produktivitasnya tidak beringsut dari angka 1,27 perrsen.</p>
            ...
            <div class="da-slide">
                <h2>Bencana Alam</h2>
                <h4>7 Bencana Alam Mengerikan dipicu Pemanasan Global</h4>
                <p>IPCC menyimpulkan bahwa sebagian besar peningkatan suhu rata-rata global sejak pertengahan Abad ke-20, kemungkinan besar, disebabkan oleh naiknya konsentrasi gas-gas rumah kaca akibat aktivitas manusia --melalui efek rumah kaca.</p>
                <a href="#" class="da-link button">Read more</a>
                <div class="da-img">
            ...
            <div class="da-slide">
                <h2>Kependudukan</h2>
                <h4>Menilai Situasi Kependudukan Indonesia</h4>
                <p>"Tahun 2030 nanti, hampir 10 persen penduduk akan berusia 60 tahun ke atas. Kita perlu mendukung penduduk lansia agar menjadi sehat dan produktif serta menjadi lansia aktif," kata jelas Sigit dalam sambutan Konferensi Internasional Dua Tahunan Asia Tenggara mengenai Kependudukan dan Kesehatan 2018 di Shinghasari Resort, Kota Batu, Malang, Jawa Timur, pada Kamis (8/11/2018).</p>
                <a href="#" class="da-link button">Read more</a>
                <div class="da-img">
...
<div id="price" class="section secondary-section">
    <div class="container">
        <div class="title">
            <h1>Tentang</h1>
            <p>SmartEco merupakan aplikasi yang membantu pemerintah pusat dan daerah dalam mengelola lingkungan pada daerahnya.</p>
        </div>
        ...
        <div class="centered">
            <p class="price-text">Untuk info lebih lanjut</p>
            <a href="#contact" class="button">Kontak Kami</a>
        </div>
    </div>
</div>
<!-- Price section end -->

...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-lg"><b>Perda</b>SmartEco</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Jawa Tengah</span>
            </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="/datawilayah">
            <i class="fa fa-user"></i> <span>Data Wilayah</span>
        ...
        <li class="treeview">
          <a href="/sensusprofesi">
            <i class="fa fa-th"></i> <span>Sensus Profesi</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
              </a>
        ...
        <li class="treeview">
          <a href="/kehijauanwilayah">
            <i class="fa fa-calendar"></i> <span>Kehijauan Wilayah</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
              </a>
        ...
        <li class="treeview"><a href="/foto"><i class="fa fa-book"></i> <span>Foto Kegiatan</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="/foto"><i class="fa fa-circle"></i> List </a></li>
                <li class="active"><a href="/tambah_foto"><i class="fa fa-circle"></i> Tambah </a></li>
              </ul>
        </li>
      </ul>
    </section>
